 ...
 * @author Gato Sagrado
 */
public class GerenciarEditoras extends javax.swing.JPanel implements GlobalInterface {
    ...
    private void BtCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtCadastroActionPerformed
        TelaPrincipal.sobrepor(new CadastroSimples(this, -1, 'e'));
    ...
    private void listar(){
        ...
        ArrayList<PnEditoraGerenciar> lista = dao.listarGerenciar(busca);
        if(lista != null){
            if(lista.isEmpty()){
            ...
            for (int i = 0; i < lista.size(); i++) {
                PnEditoraGerenciar p = lista.get(i);
