 ...
 * @author Gato Sagrado
 */
public class GerenciarMovimentos extends javax.swing.JPanel implements GlobalInterface {
    ...
    private void BtCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtCadastroActionPerformed
        TelaPrincipal.sobrepor(new CadastroSimples(this, -1, 'm'));
    ...
    private void listar(){
        ...
        ArrayList<PnMovimentoGerenciar> lista = dao.listarGerenciar(busca);
        if(lista != null){
            if(lista.isEmpty()){
            ...
            for (int i = 0; i < lista.size(); i++) {
                PnMovimentoGerenciar p = lista.get(i);
