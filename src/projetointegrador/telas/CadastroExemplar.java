...
public class CadastroExemplar extends javax.swing.JPanel {
     ...
     */
    public CadastroExemplar(GlobalInterface origem, int id) {
        initComponents();
        this.id = id;
    ...
    private void BtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtSalvarActionPerformed
        if(!TxLocal.getText().isEmpty()&&CbLivro.getSelectedIndex()!=-1){
            ...
            if(id==-1){
                dao.cadastrarExemplar(idlivro, TxLocal.getText());
            }
            else{
                dao.alterarExemplar(id, idlivro, TxLocal.getText());
            }
    ...
    private void atualizar(){
        ...
        ArrayList<String> lista = ldao.listarGerenciarExemplares(id);
        for (String s : lista){
            CbLivro.addItem(s);
        }
        if(id!=-1){
            ...
            ExemplaresDAO dao = new ExemplaresDAO(Conector.conectar());
            Exemplares e = dao.exemplar(id);
            TxLocal.setText(e.getLocalizacao());
        }
        else{
            CbLivro.setSelectedIndex(-1);
        }
