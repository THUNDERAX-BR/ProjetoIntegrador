 ...
 * @author Gato Sagrado
 */
public class GerenciarExemplares extends javax.swing.JPanel implements GlobalInterface {
    ...
    private void BtCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtCadastroActionPerformed
        TelaPrincipal.sobrepor(new CadastroExemplar(this, -1));
    ...
    private void listar(){
        ...
        ArrayList<PnExemplarGerenciar> lista = dao.listarGerenciar(busca);
        if(lista != null){
            if(lista.isEmpty()){
            ...
            for (int i = 0; i < lista.size(); i++) {
                PnExemplarGerenciar p = lista.get(i);
