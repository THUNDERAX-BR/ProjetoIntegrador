 ...
 * @author Gato Sagrado
 */
public class GerenciarLogins extends javax.swing.JPanel implements GlobalInterface{
    ...
    private void BtCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtCadastroActionPerformed
        TelaPrincipal.sobrepor(new CadastroLogin(this));
    ...
    private void listar(){
        ...
        ArrayList<PnLoginGerenciar> lista = dao.listarGerenciar(busca);
        if(lista != null){
            if(lista.isEmpty()){
            ...
            for (int i = 0; i < lista.size(); i++) {
                PnLoginGerenciar p = lista.get(i);
