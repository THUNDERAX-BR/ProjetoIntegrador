 ...
 * @author Gato Sagrado
 */
public class GerenciarAutores extends javax.swing.JPanel implements GlobalInterface {
    ...
    private void BtCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtCadastroActionPerformed
        TelaPrincipal.sobrepor(new CadastroAutor(this, -1));
    ...
    private void listar(){
        ...
        ArrayList<PnAutorGerenciar> lista = dao.listarGerenciar(busca);
        if(lista != null){
            if(lista.isEmpty()){
            ...
            for (int i = 0; i < lista.size(); i++) {
                PnAutorGerenciar p = lista.get(i);
