 ...
 * @author Gato Sagrado
 */
public class GerenciarCategorias extends javax.swing.JPanel implements GlobalInterface {
    ...
    private void BtCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtCadastroActionPerformed
        TelaPrincipal.sobrepor(new CadastroSimples(this, -1, 'c'));
    ...
    private void listar(){
        ...
        ArrayList<PnCategoriaGerenciar> lista = dao.listarGerenciar(busca);
        if(lista != null){
            if(lista.isEmpty()){
            ...
            for (int i = 0; i < lista.size(); i++) {
                PnCategoriaGerenciar p = lista.get(i);
