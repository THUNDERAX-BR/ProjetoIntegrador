...
public class InfoAutor extends javax.swing.JPanel {
    ...
    private void exibir(int id){
        ...
        Autores a = adao.exibirAutor(id);
        if(a.getFoto()!=null){
            LbFoto.setIcon(a.getFoto());
        }
        LbNome.setText(a.getNome());
        LbId.setText("ID: "+id);
        LbMovimento.setText(a.getMovimento().getNome());
        LbNasc.setText(a.getDataNascimento());
        if(a.getDataFalecimento()!=null){
            LbNasc.setText(LbNasc.getText()+" - "+a.getDataFalecimento());
        }
        TxBiografia.setText(a.getBiografia());
        
        LivrosDAO ldao = new LivrosDAO(Conector.conectar());
        ArrayList<PnLivroInfoAutor> lista = ldao.exbirLivrosAutor(id);
        if(lista != null){
            PnAux.removeAll();
